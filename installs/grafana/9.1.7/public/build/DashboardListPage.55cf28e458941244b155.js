"use strict";(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[4074],{72794:(e,a,r)=>{r.r(a),r.d(a,{DashboardListPage:()=>k,default:()=>F});var s=r(36636),n=r(68404),o=r(17614),t=r(43215),l=r(90923),d=r(69371),i=r(28659),c=r(49545);var u,h,p=r(92115),m=r(93368),g=r(3490),f=r(61959),v=r(47570),b=r(97621),x=r(51189),w=r(71625),y=r(12568),j=r(45916);const N=e=>{let{folderId:a,canCreateFolders:r=!1,canCreateDashboards:s=!1}=e;const n=e=>{let r=`dashboard/${e}`;return a&&(r+=`?folderId=${a}`),r};return(0,j.jsx)("div",{children:(0,j.jsx)(g.Dropdown,{overlay:()=>(0,j.jsxs)(g.Menu,{children:[s&&(0,j.jsx)(g.Menu.Item,{url:n("new"),label:"New Dashboard"}),!a&&r&&(u||(u=(0,j.jsx)(g.Menu.Item,{url:"dashboards/folder/new",label:"New Folder"}))),s&&(0,j.jsx)(g.Menu.Item,{url:n("import"),label:"Import"})]}),placement:"bottom-start",children:h||(h=(0,j.jsxs)(g.Button,{variant:"primary",children:["New",(0,j.jsx)(g.Icon,{name:"angle-down"})]}))})})};const I=n.memo((e=>{var a;let{folder:r}=e;const o=(0,g.useStyles2)(D),{query:t,onQueryChange:d}=(0,w.A)({}),{onKeyDown:i,keyboardEvents:c}=(0,x.A)(),u=null==r?void 0:r.id,h=null==r?void 0:r.canSave,{isEditor:I}=f.Vt,C=r?h:f.Vt.hasEditPermissionInFolders,k=f.Vt.hasAccess(v.bW.FoldersCreate,I),F=f.Vt.hasAccess(v.bW.DashboardsCreate,C||!!h);let[T,$]=(0,p.Z)(b.to,!0);l.config.featureToggles.panelTitleSearch||(T=!1);const[P,S]=(0,n.useState)(null!==(a=t.query)&&void 0!==a?a:"");return(0,m.Z)((()=>d(P)),200,[P]),(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)("div",{className:(0,s.cx)(o.actionBar,"page-action-bar"),children:[(0,j.jsx)("div",{className:(0,s.cx)(o.inputWrapper,"gf-form gf-form--grow m-r-2"),children:(0,j.jsx)(g.Input,{value:P,onChange:e=>{e.preventDefault(),S(e.currentTarget.value)},onKeyDown:i,autoFocus:!0,spellCheck:!1,placeholder:T?"Search for dashboards and panels":"Search for dashboards",className:o.searchInput,suffix:null})}),k&&F&&(0,j.jsx)(N,{folderId:u,canCreateFolders:k,canCreateDashboards:F})]}),(0,j.jsx)(y.Z,{showManage:I||C||h,folderDTO:r,queryText:t.query,onQueryTextChange:e=>{S(e)},hidePseudoFolders:!0,includePanels:T,setIncludePanels:$,keyboardEvents:c})]})}));I.displayName="ManageDashboardsNew";const C=I,D=e=>({actionBar:s.css`
...
//# sourceMappingURL=DashboardListPage.55cf28e458941244b155.js.map